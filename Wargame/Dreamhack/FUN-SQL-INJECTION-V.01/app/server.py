...
FLAG = "DH{find_real_flag_th1s_Is_Fake_F1ag_!}"
PASSWORD = "dsmkasj8irju3h8u34902uh8f43rtu428ru5h3"
...
def first_insert():
    sql = f"""INSERT INTO authTBL (id, username, password, user_group, comment) VALUES 
        ...
        (2, 'fldk1', 'fldk1', 'guest', 'what is this?'),
        (3, 'june', 'june', 'vip', 'html is programming language!! lol'),
        (4, 'jun0911', 'jun0911', 'guest', 'I am newbie...!'),
        (5, 'developer', 'developer', 'guest', 'I am developer'),
        (6, 'user1234', 'guest1234', 'guest', 'hacking is fun'),
        (7, 'deny', 'deny', 'guest', 'hehe'),
        (8, 'danli', 'danli', 'guest', 'I want to be a hacker'),
        (9, 'david', 'david', 'vip', 'fun'),
        (10, 'FLAG', '{PASSWORD}', 'vip', '{FLAG}')
    """
    sql2 = "INSERT INTO adminTBL (admin_name, admin_group, secret_key) VALUES ('super_admin', 'super_admin', 'SECRET{Th1s_1s_vr@y_sr@ttE#@_K2Y@!$@!@#_H@ppy!}')"
    authTBL_insert(sql)
    authTBL_insert(sql2)
